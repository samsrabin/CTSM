...
def test_check_lon_type_180(lon):
    """
...
def test_check_lon_type_180_list():
    """
...
def test_check_lon_type_180_errors():
    """
...
def test_check_lon_type_180_list_errors():
    """
...
def test_check_lon_type_360(lon):
    """
...
def test_check_lon_type_360_list():
    """
...
def test_check_lon_type_360_errors():
    """
...
def test_check_lon_type_360_list_errors():
    """
...
def test_convert_lon_type_180_to_360(lon_in, lon_exp):
    """Test conversion 180→360"""
    lon_out = _convert_lon_type_180_to_360(lon_in)
    assert lon_out == lon_exp


def test_convert_lon_type_180_to_360_toohigh():
...
def test_convert_lon_type_180_to_360_toolow():
    """Test conversion 180→360 for a value < -180: Should error"""
    lon = -555
...
def test_convert_lon_type_360_to_180_positive_low():
...
def test_convert_lon_type_360_to_180_positive_high():
...
def test_convert_lon_type_360_to_180_lowerbound():
...
def test_convert_lon_type_360_to_180_upperbound():
...
def test_convert_lon_type_360_to_180_toohigh():
...
def test_convert_lon_type_360_to_180_toolow():
    """Test conversion 360→180 for a value < -180: Should error"""
    lon = -555
...
def test_lon_obj_type180(this_lon):
...
def test_lon_obj_type360_pos(this_lon):
...
def test_lon_compare_difftypes_error():
    """
...
def test_lon_compare_notlon_error():
    """
