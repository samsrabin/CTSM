...
class TestVarHasRawNan:
    """Tests for var_has_rawnan covering simple and slicing branches."""
    ...
    class _SmallFakeDataArray:
        ...
        Implements the minimal interface used by var_has_rawnan.
        """
    ...
    class _BigFakeDataArray:
        ...
        def isel(self, indexers, drop=True):
            ...
            return TestVarHasRawNan._SmallFakeDataArray(has_null)
    ...
    def test_break_stops_iteration(self):
        ...
        class TrackingBig:
            ...
            def isel(self, indexers, drop=True):
                ...
                if idx == 0:
                    return TestVarHasRawNan._SmallFakeDataArray(True)
    ...
    def test_continues_until_true(self):
        ...
        class ContinueBig:
            ...
            def isel(self, indexers, drop=True):
                ...
                return TestVarHasRawNan._SmallFakeDataArray(idx == 2)
