...
# on outputs of the rxcropmaturity test suite. For RXCROPMATURITYSCRIPTS tests (i.e., skipping the
...
#        RXCROPMATURITYSCRIPTSINST_Ld1097.f10_f10_mg37.IHist check_rxboth_run ✅
#        RXCROPMATURITYSCRIPTS_Ld1097.f10_f10_mg37.IHist check_rxboth_run 🔴
#     npl
#        RXCROPMATURITYINST_Lm61.f10_f10_mg37.IHist check_rxboth_run ✅
#        RXCROPMATURITY_Lm61.f10_f10_mg37.IHist generate_gdds ✅
#        RXCROPMATURITYSCRIPTSINST_Ld1097.f10_f10_mg37.IHist check_rxboth_run ✅
