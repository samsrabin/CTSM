...
contains
  ...
  subroutine CNPhenologyClimate (num_soilp, filter_soilp, num_pcropp, filter_pcropp, &
    ...
    associate(                                                & 
         ...
         gdd020         => temperature_inst%gdd020_orig_patch  ,   & ! Output: [real(r8) (:) ]  20-yr mean of gdd0 (ddays)                        
         gdd820         => temperature_inst%gdd820_orig_patch  ,   & ! Output: [real(r8) (:) ]  20-yr mean of gdd8 (ddays)                        
         gdd1020        => temperature_inst%gdd1020_orig_patch ,   & ! Output: [real(r8) (:) ]  20-yr mean of gdd10 (ddays)                       
