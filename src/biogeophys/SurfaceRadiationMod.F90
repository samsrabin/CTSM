...
contains
  ...
  subroutine CanopySunShadeFracs(filter_nourbanp, num_nourbanp,  &
    ...
    associate( tlai_z  => surfalb_inst%tlai_z_patch, &    ! tlai increment for canopy layer
          ...
          forc_solad  => atm2lnd_inst%forc_solad_not_downscaled_grc, &   ! direct beam radiation (W/m**2)
  ...
  subroutine SurfaceRadiation(bounds, num_nourbanp, filter_nourbanp, &
     ...
     associate(                                                     &
          ...
          forc_solad  =>    atm2lnd_inst%forc_solad_not_downscaled_grc     , & ! Input:  [real(r8) (:,:) ] direct beam radiation, column (W/m**2)
